...
const requestIgnoredKeys: Record<string, routerDTOKeyType[]> = {
    CREATE : [ "user", "tags", ...createRequestBodyOmittedKeys ],
    UPDATE : [ "user", "tags", ...updateRequestBodyOmittedKeys ]
}
...
type BlogReadResponse =
    ...
    DataResponseBody<
        ReadResponseContent<BlogModelDTO, never, "imageURL" | "publishedDate">,
        "Blog",
...
type BlogReadManyResponse =
    DataResponseBody<
        Array<ReadResponseContent<BlogModelDTO, never, "imageURL" | "publishedDate">>,
        "Blog",
        FoundResponseMessageT
    >
...
type BlogCreateRequest = CreateRequestBody<BlogModelDTO, "user" | "tags", "imageURL" | "publishedDate">

/** Possible responses for {@link BlogController.createBlog} */
type BlogCreateResponse =
    DataResponseBody<
        CreateResponseContent<BlogModelDTO, never, "imageURL" | "publishedDate">,
        "Blog",
...
type BlogUpdateRequest = UpdateRequestBody<BlogModelDTO, "user" | "tags", never>

/** Possible responses for {@link BlogController.updateBlog} */
type BlogUpdateResponse =
    DataResponseBody<
        UpdateResponseContent<BlogModelDTO, never, "imageURL" | "publishedDate">,
        "Blog",
